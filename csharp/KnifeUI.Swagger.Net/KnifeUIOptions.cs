...
namespace KnifeUI.Swagger.Net
{
    public class KnifeUIOptions
    {
        ...
        /// </summary>
        public Func<Stream?> IndexStream { get; set; } = () => typeof(KnifeUIOptions).GetTypeInfo().Assembly.GetManifestResourceStream("KnifeUI.Swagger.Net.doc.html");
