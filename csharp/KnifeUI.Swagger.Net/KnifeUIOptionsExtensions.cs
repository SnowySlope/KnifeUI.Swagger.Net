...
{
    public static class KnifeUIOptionsExtensions
    {
        /// <summary>
        /// Injects additional CSS stylesheets into the doc.html page
        /// </summary>
        ...
        public static void InjectStylesheet(this KnifeUIOptions options, string path, string media = "screen")
        {
        ...
        /// <summary>
        /// Injects additional Javascript files into the doc.html page
        /// </summary>
        /// <param name="options"></param>
        ...
        public static void InjectJavascript(this KnifeUIOptions options, string path, string type = "text/javascript")
        {
            var builder = new StringBuilder(options.HeadContent);
        ...
        public static void SwaggerEndpoint(this KnifeUIOptions options, string url, string name)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void EnableDeepLinking(this KnifeUIOptions options)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void DisplayOperationId(this KnifeUIOptions options)
        {
        ...
        public static void DefaultModelsExpandDepth(this KnifeUIOptions options, int depth)
        {
        ...
        /// <param name="options"></param>
        /// <param name="depth"></param>
        public static void DefaultModelExpandDepth(this KnifeUIOptions options, int depth)
        {
        ...
        public static void DefaultModelRendering(this KnifeUIOptions options, ModelRendering modelRendering)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void DisplayRequestDuration(this KnifeUIOptions options)
        {
        ...
        public static void DocExpansion(this KnifeUIOptions options, DocExpansion docExpansion)
        {
        ...
        public static void EnableFilter(this KnifeUIOptions options, string? expression = null)
        {
        ...
        public static void MaxDisplayedTags(this KnifeUIOptions options, int count)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void ShowExtensions(this KnifeUIOptions options)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void ShowCommonExtensions(this KnifeUIOptions options)
        {
        ...
        public static void SupportedSubmitMethods(this KnifeUIOptions options, params SubmitMethod[] submitMethods)
        {
        ...
        public static void OAuth2RedirectUrl(this KnifeUIOptions options, string url)
        {
            options.ConfigObject.OAuth2RedirectUrl = url;
        }

        [Obsolete("The validator is disabled by default. Use EnableValidator to enable it")]
        public static void ValidatorUrl(this KnifeUIOptions options, string url)
        {
        ...
        /// <param name="options"></param>
        /// <param name="url"></param>
        public static void EnableValidator(this KnifeUIOptions options, string url = "https://online.swagger.io/validator")
        {
            options.ConfigObject.ValidatorUrl = url;
        }
        ...
        [Obsolete]
        public static void OAuthClientId(this KnifeUIOptions options, string value)
        {
        ...
        /// <param name="value"></param>
        [Obsolete]
        public static void OAuthClientSecret(this KnifeUIOptions options, string value)
        {
        ...
        /// <param name="value"></param>
        [Obsolete]
        public static void OAuthRealm(this KnifeUIOptions options, string value)
        {
        ...
        /// <param name="value"></param>
        [Obsolete]
        public static void OAuthAppName(this KnifeUIOptions options, string value)
        {
        ...
        /// <param name="value"></param>
        [Obsolete]
        public static void OAuthScopeSeparator(this KnifeUIOptions options, string value)
        {
        ...
        /// <param name="options"></param>
        [Obsolete]
        public static void OAuthUseBasicAuthenticationWithAccessCodeGrant(this KnifeUIOptions options)
        {
        ...
        /// <param name="options"></param>
        [Obsolete]
        public static void OAuthUsePkce(this KnifeUIOptions options)
        {
